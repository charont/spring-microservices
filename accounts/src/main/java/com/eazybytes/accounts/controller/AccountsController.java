...
import com.eazybytes.accounts.config.AccountsConfig;
...
public class AccountsController {
	...
	@Retry(name= "retryForCustomerDetails", fallbackMethod = "myCustomDetailsFallBack")
	...
	private CustomerDetails myCustomDetailsFallBack(@RequestHeader("eazybank-correlation-id") String correlationid,Customer customer, Throwable t) {
		Accounts accounts = accountsRepository.findByCustomerId(customer.getCustomerId());
		List<Loans> loans = loansFeignClient.getLoansDetails(correlationid,customer);
		CustomerDetails customerDetails = new CustomerDetails();
		customerDetails.setAccounts(accounts);
